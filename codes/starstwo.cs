...
public class starstwo : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            Debug.Log("girdi");
            other.gameObject.transform.root.gameObject.GetComponent<gecis>().yildiziki = true; 
    ...
    private void OnTriggerExit2D(Collider2D collision)
    {
        ...
        {
            Debug.Log("cıkti");// collision.gameObject.transform.root.gameObject.GetComponent<gecis>().yildiziki = false; 
        }
    }
}
